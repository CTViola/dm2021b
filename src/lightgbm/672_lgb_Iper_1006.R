...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower= 0.01 , upper=    0.0457),
  makeNumericParam("feature_fraction", lower= 0.241, upper= 0.996),
  makeIntegerParam("min_data_in_leaf", lower= 1116, upper= 2003),
  makeIntegerParam("num_leaves",       lower= 867L, upper= 910L),
  makeNumericParam("prob_corte",       lower= 0.044, upper= 0.047)
)
