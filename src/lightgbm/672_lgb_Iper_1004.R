...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower= 0.010 , upper=  0.064),
  makeNumericParam("feature_fraction", lower= 0.200  , upper= 0.974),
  makeIntegerParam("min_data_in_leaf", lower= 1244, upper= 6689),
  makeIntegerParam("num_leaves",       lower= 92L   , upper= 1024L),
  makeNumericParam("prob_corte",       lower= 0.036, upper= 0.053)
)
