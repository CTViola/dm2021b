...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower= 0.010, upper= 0.100),
  makeNumericParam("feature_fraction", lower= 0.418, upper= 0.998),
  makeIntegerParam("min_data_in_leaf", lower= 933, upper= 3570),
  makeIntegerParam("num_leaves",       lower=16L   , upper= 973L),
  makeNumericParam("prob_corte",       lower= 0.036, upper= 0.049)
)
