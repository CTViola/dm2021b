...
hs <- makeParamSet( 
  makeNumericParam("learning_rate",    lower= 0.011, upper=    0.088),
  makeNumericParam("feature_fraction", lower= 0.204, upper=    0.676),
  makeIntegerParam("min_data_in_leaf", lower= 223, upper= 4443),
  makeIntegerParam("num_leaves",       lower=16L   , upper= 310L),
  makeNumericParam("prob_corte",       lower= 0.034, upper=    0.051)
)
